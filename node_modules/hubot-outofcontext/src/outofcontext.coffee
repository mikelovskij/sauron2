...
giangiQuote = (randomQuote, msg) ->
  quote = ["Ma l'altro giorno avevi detto \"#{randomQuote}\" , #{msg.message.username}", "O come dice #{msg.message.username} , \"#{randomQuote}\" hahahahahaha che ridere", "L'hai detto tu che \"#{randomQuote}\" eheheheh che burlone"]
