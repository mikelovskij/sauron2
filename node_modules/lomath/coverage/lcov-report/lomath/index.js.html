...
<html lang="en">
<head>
    <title>Code coverage report for lomath/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lomath/index.js</span></h1>
    <h2>
        Statements: <span class="metric">100% <small>(461 / 461)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">100% <small>(182 / 182)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(163 / 163)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">100% <small>(434 / 434)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric">7 branches</span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lomath/</a> &#187; index.js</div>
</div>
<div class="body">
...
3008
3009
3010</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  asso: function(fn, argObj) {
    ...
    var args = len &lt; 3 ? <span class="branch-0 cbranch-skip" title="branch not covered" >argObj </span>: _.toArray(argObj),
...
&nbsp;
  ...
  reMatch: function(regex) {
    return function(str) {
      /* istanbul ignore next */
      <span class="skip-if-branch" title="else path not taken" >E</span>if (str != undefined)
...
&nbsp;
  ...
  seq: function(start, stop, step) {
    if (stop == null) {
      /* istanbul ignore next */
      stop = start || <span class="branch-1 cbranch-skip" title="branch not covered" >1;</span>
      start = 1;
    }
    step = step || 1;
...
&nbsp;
  ...
  expVal: function(X, P, fn) {
    ...
    // if X, fn specified
    /* istanbul ignore next */
    else <span class="skip-if-branch" title="else path not taken" >E</span>if (typeof P === 'function') {
      var hist = lomath.histogram(X);
      val = hist.value,
        prob = hist.prob;
      func = P;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sat Jan 30 2016 23:18:17 GMT-0500 (EST)</div>
</div>
